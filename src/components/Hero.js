const Hero = () => {
    return(
        ...
        <div className="hero">
         ...
         <h2 className="hero-text"><span className="fas fa-key-skeleton"></span><span className="unlock text">Unlock</span><br/> <span className="unlock">Data</span> Precision</h2>
         ...
         <div className="right-side">
           <ul>
            ...
            <li className="last"><i class="far fa-car"></i>E-commerce</li>
            <li className="last"><i class="far fa-car"></i>Healthcare</li>
            <li className="last "><i class="far fa-car"></i>Security</li>
            <li className="last lastfinal"><i class="far fa-car"></i>Insurance</li>
           </ul>
         </div>
        </div>
        </>
